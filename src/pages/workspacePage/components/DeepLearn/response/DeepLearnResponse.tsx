        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-gray-300 rounded-2xl p-4 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                <span className="text-gray-700 font-['Inter',Helvetica] text-sm">Start a</span>
                <button className="bg-[#F9F9F9] border border-[#D9D9D9] text-[#4A4A4A] rounded-xl px-3 py-1.5 font-['Inter',Helvetica] text-sm hover:bg-gray-100">
                  Follow Up
                </button>
                <span className="text-gray-500 font-['Inter',Helvetica] text-sm">or</span>
                <button className="bg-[#F9F9F9] border border-[#D9D9D9] text-[#4A4A4A] rounded-xl px-3 py-1.5 font-['Inter',Helvetica] text-sm hover:bg-gray-100">
                  New Topic
                </button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <button className="bg-[#F9F9F9] border border-[#D9D9D9] text-[#4A4A4A] rounded-xl px-2.5 py-1 text-sm font-['Inter',Helvetica] hover:bg-gray-100">
                    New Topic
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <div 
                      className={`absolute top-1 w-[84px] h-[22px] bg-white rounded-[14px] transition-all duration-300 ease-in-out z-10 ${
                        selectedMode === 'deep-learn' ? 'left-1.5' : 'left-[94px]'
                      }`} 
                    />
